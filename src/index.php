...
<body class="mx-5 md:mx-10 font-Comfortaa" >
  <header class="flex justify-around flex-wrap items-center bg-blue-900 rounded md:px-10 ">
    ...
    <div class="flex items-center flex-shrink-0 text-whit ">
     <a href="index.php"><img class="h-10 sm:h-14 inline" src="imgs/Logo.png" alt=""></a> 
    ...
    ?>
      <a href="../segunda_ent/negocio/productos/carrito/carrito.php"><img src="imgs/carrito.png" class="h-10 inline-block mr-4 hover:border-b" alt=""></a>
      <?php
}
?>
...
?>
        <div x-data="{ open: false }" class="inline">
          ...
          <div x-show="open" class="absolute text-center right-24 sm:right-60 md:right-11 mx-3 md:mx-0  z-10 border border-black bg-blue-900
            ...
            <a href="../segunda_ent/negocio/usuario/login.php" class="block mx-4 py-1 text-sm text-white hover:border-b" role="menuitem" tabindex="-1" id="user-menu-item-0">Ingresar</a>
            <a href="../segunda_ent/negocio/usuario/registrarse.php" class="block mx-4 py-1 text-sm text-white hover:border-b" role="menuitem" tabindex="-1" id="user-menu-item-1">Registrarse</a>
          </div>
        </div>
      ...
      <nav class="mt-2 hidden md:flex md:justify-center">
        <div class="  flex justify-center  id="menuCategorias">
          <ul x-show="open" class=" hidden md:flex  items-center bg-slate-800 rounded">
            <li><a href="../segunda_ent/negocio/productos/Pags/Cascos.php"><img class="h-10 px-5 m-2 mt-2" src="imgs/casco.png" alt=""><p class="flex text-white justify-center hover:border-b mb-2 mx-3">Cascos</p></a></li>
            <li><a href="../segunda_ent/negocio/productos/Pags/Chalecos.php"><img class="h-10 px-5 m-2 mt-2" src="imgs/Chaleco.png" alt=""><p class="flex text-white justify-center hover:border-b mb-2 mx-3">Chalecos</p></a></li>
            <li><a href="../segunda_ent/negocio/productos/Pags/Uniformes.php"><img class="h-10 px-5 m-2 mt-2" src="imgs/Uniforme.png" alt=""><p class="flex text-white justify-center hover:border-b mb-2 mx-3">Uniformes</p></a></li>
            <li><input class="h-6" type="text"></li>
            <li><img class="h-6 p-1 border"src="imgs/Lupa2.png" alt=""></li>            
            <li><a href="../segunda_ent/negocio/productos/Pags/Combos.php"><img class="h-11 px-5 m-2 mt-2" src="imgs/Combos.png" alt=""><p class="flex text-white justify-center hover:border-b mb-2 mx-3">Combos</p></a></li>
            <li><a href="../segunda_ent/negocio/productos/Pags/Ofertas.php"><img class="h-11 px-5 m-2 mt-2" src="imgs/Ofertas.png" alt=""><p class="flex text-white justify-center hover:border-b mb-2 mx-3">Ofertas</p></a></li>
            <li><a href="../segunda_ent/negocio/productos/Pags/Botas.php"><img class="h-10 px-5 m-2 mt-2" src="imgs/Botas.png" alt=""><p class="flex text-white justify-center hover:border-b mb-2 mx-3">Botas</p></a></li>
      ...
      <div  class="  flex-col w-auto md:hidden absolute mt-1 lg:left-0 mr-5
        ...
        <div id="menu2" class="flex-col hidden mx-14">
          ...
          <div class="p-2.5  flex items-center justify-between rounded-md px-4 duration-300
                      ...
                      <a href="../segunda_ent/negocio/productos/Pags/Cascos.php"><img class="h-6 m-2 p-auto inline" src="imgs/casco.png" alt=""></a>  
          ...
          <div class="p-2.5  flex items rounded-md px-4 duration-300
                      cursor-pointer hover:bg-blue-700 text-white">
                      <a href="../segunda_ent/negocio/productos/Pags/Chalecos.php"><img class="h-6 m-2 p-auto inline" src="imgs/Chaleco.png" alt=""></a>  
          ...
          <div class="p-2.5  flex items rounded-md px-4 duration-300
                      cursor-pointer hover:bg-blue-700 text-white">
                      <a href="../segunda_ent/negocio/productos/Pags/Uniformes.php"><img class="h-6 m-2 p-auto inline" src="imgs/Uniforme.png" alt=""></a>  
          ...
          <div class="p-2.5  flex items rounded-md px-4 duration-300
                      cursor-pointer hover:bg-blue-700 text-white">
                      <a href="../segunda_ent/negocio/productos/Pags/Botas.php"><img class="h-6 m-2 p-auto inline" src="imgs/Botas.png" alt=""></a>  
          ...
          <div class="p-2.5  flex items rounded-md px-4 duration-300
                      cursor-pointer hover:bg-blue-700 text-white">
                      <a href="../segunda_ent/negocio/productos/Pags/Ofertas.php"><img class="h-6 m-2 p-auto inline" src="imgs/Ofertas.png" alt=""></a>  
          ...
          <div class="p-2.5  flex items-center justify-between rounded-md px-4 duration-300
                      cursor-pointer hover:bg-blue-700 text-white">
                      <a href="../segunda_ent/negocio/productos/Pags/Combos.php"><img class="h-7 m-2 p-auto inline" src="imgs/Combos.png" alt=""></a>  
        ...
        <div class="   ">
          <div class="  grid grid-cols-1 md:grid-cols-3 w-full ">
            ...
            <div class="flex col-span-1  sm:col-span-3 justify-center items-center">
              ...
              <img class="h-16 md:h-24 lg:h-28 inline" src="./imgs/Logo.png" alt="">
            ...
            <div class="m-auto mt-3 p-auto h-auto">
              ...
              <ul class="flex ml-5 hover:text-white">
                ...
                <li><a href=""><img class="w-12 rounded-full mx-2 " src="./imgs/Instagram_logo_2022.svg" alt=""></a></li>
                <li><a href=""><img class="w-12 rounded-full mx-2 " src="./imgs/Instagram_logo_2022.svg" alt=""></a></li>
                <li><a href=""><img class="w-12 rounded-full mx-2 " src="./imgs/Instagram_logo_2022.svg" alt=""></a></li>
  ...
  <header class="flex items-center justify-center flex-wrap bg-blue-900 rounded ">
    ...
    <div id="menu" class="w-full mt-5 hidden flex-grow md:flex md:items-center md:w-auto text-end mr-10">
      ...
      <nav class="mt-2 hidden md:flex md:justify-center">
        <div class="  flex justify-center  id="menuCategorias">
          <ul x-show="open" class=" hidden md:flex  items-center bg-slate-800 rounded">
            <li><a href="../Pags/Cascos.php"><img class="h-10 px-5 m-2 mt-2" src="imgs/casco.png" alt=""><p class="flex text-white justify-center">Cascos</p></a></li>
            <li><a href="../Pags/Chalecos.php"><img class="h-10 px-5 m-2 mt-2" src="imgs/Chaleco.png" alt=""><p class="flex text-white justify-center">Chalecos</p></a></li>
            <li><a href="../Pags/Uniformes.php"><img class="h-10 px-5 m-2 mt-2" src="imgs/Uniforme.png" alt=""><p class="flex text-white justify-center">Uniformes</p></a></li>
            <li><input class="h-6" type="text"></li>
            <li><img class="h-6 p-1 border"src="imgs/Lupa2.png" alt=""></li>            
            <li><a href="../Pags/Combos.php"><img class="h-11 px-5 m-2 mt-2" src="imgs/Combos.png" alt=""><p class="flex text-white justify-center">Combos</p></a></li>
            <li><a href="../Pags/Ofertas.php"><img class="h-11 px-5 m-2 mt-2" src="imgs/Ofertas.png" alt=""><p class="flex text-white justify-center">Ofertas</p></a></li>
            <li><a href=../Pags/Botas.php""><img class="h-10 px-5 m-2 mt-2" src="imgs/Botas.png" alt=""><p class="flex text-white justify-center">Botas</p></a></li>
    ...
    <div class="flex mb-10">
      ...
      <div  class=" flex-col md:hidden absolute my-3 lg:left-0 w-full mr-5
        ...
        <div id="menu2" class="flex-col">
          ...
          <div class="p-2.5  flex items-center justify-between rounded-md px-4 duration-300
                      cursor-pointer hover:bg-blue-700 text-white" >
                      <a href="../Pags/Cascos.php"><img class="h-6 m-2 p-auto inline" src="imgs/casco.png" alt=""></a>  
                      <p class=" m-auto p-auto text-sm md:text-lg text-white justify-between">Cascos</p>
                    <span class="text-sm m-auto p-auto" id="arrow">
                       <i class="bi bi-chevron-down"></i>    
                    </span>
          ...
          <div class="p-2.5  flex items rounded-md px-4 duration-300
                      cursor-pointer hover:bg-blue-700 text-white">
                      <a href="../Pags/Chalecos.php"><img class="h-6 m-2 p-auto inline" src="imgs/Chaleco.png" alt=""></a>  
                      <p class=" m-auto p-auto text-sm md:text-lg text-white justify-between">Chalecos</p>        
                      <span class="text-sm m-auto p-auto" id="arrow">
                        <i class="bi bi-chevron-down"></i>    
                     </span>
          ...
          <div class="p-2.5  flex items rounded-md px-4 duration-300
                      cursor-pointer hover:bg-blue-700 text-white">
                      <a href="../Pags/Uniformes.php"><img class="h-6 m-2 p-auto inline" src="imgs/Uniforme.png" alt=""></a>  
                      <p class=" m-auto p-auto text-sm md:text-lg text-white justify-between">Uniformes</p>        
                      <span class="text-sm m-auto p-auto" id="arrow">
                        <i class="bi bi-chevron-down"></i>    
                     </span>
          ...
          <div class="p-2.5  flex items rounded-md px-4 duration-300
                      cursor-pointer hover:bg-blue-700 text-white">
                      <a href="../Pags/Botas.php"><img class="h-6 m-2 p-auto inline" src="imgs/Botas.png" alt=""></a>  
                      <p class=" m-auto p-auto text-sm md:text-lg text-white justify-center">Botas</p>        
                      <span class="text-sm m-auto p-auto" id="arrow">
                        <i class="bi bi-chevron-down"></i>    
                     </span>
          ...
          <div class="p-2.5  flex items-center justify-between rounded-md px-4 duration-300
                      cursor-pointer hover:bg-blue-700 text-white">
                      <a href="../Pags/Combos.php"><img class="h-7 m-2 p-auto inline" src="imgs/Combos.png" alt=""></a>  
                      <p class=" m-auto p-auto text-sm md:text-lg text-white justify-between">Combos</p>        
                      <span class="text-sm m-auto p-auto" id="arrow">
                        <i class="bi bi-chevron-down"></i>    
                     </span>
        ...
        <div class="flex flex-col w-full">
          <div class="flex  w-full mt-20">
            <h2 class="text-lg md:text-3xl mx-auto pb-10  w-full text-center border-b border-gray-300">Cascos</h2>
          </div>
