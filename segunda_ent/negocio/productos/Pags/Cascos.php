...
<button name= type="submit"><img class="h-7 p-1 border"src="../../../../src/imgs/Lupa2.png" alt=""></button> 
  ...
  <div class="flex flex-col h-auto  mt-5 mx-0 md:mx-14 ">     
          ...
          <div class="flex  w-full mt-5">
            <h2 class="text-lg md:text-2xl mx-auto pb-4 w-auto px-5 text-center border-b border-gray-300 shadow-md font-semibold">Cascos</h2>
          </div>
...
$consulta = mysqli_query($con, "SELECT * FROM producto WHERE Tipo='Cabeza' limit 16") or die(mysqli_error($con));
