    ...
    <div id="menu" class="w-full mt-0 md:mt-5 hidden flex-grow md:flex md:items-center md:w-auto text-end ">
      ...
      <div class="flex flex-col h-auto  w-full mx-14  ">
          <div class="flex  w-full mt-5">
            <h2 class="text-lg md:text-2xl mx-auto pb-4 w-auto px-5 text-center border-b border-gray-300 shadow-md font-semibold">Agregar Oferta </h2>
          </div>
            ...
            <div class="flex flex-col">
              <form class="form bg-blue-900 p-5" name="formulario" method="post" action="">
                <div class="m-2 text-center">
                  <input class="controls" placeholder="Ingrese Producto" type="text" name="nom" required maxlength="30">
                </div>
                <div class="m-2 text-center">
                  <input class="botons" type="submit" value="Buscar Producto" name="buscar">
                </div>
                <div class="m-2 text-center">
                  <a href="mostrar_prod.php" class="regresar">Ver listado</a>
                </div>
                <div class="m-2 text-center">
          ...
          <div class="  grid grid-cols-1 md:grid-cols-3 w-full ">
            ...
            <div class="m-auto mt-3 p-auto h-auto">
              ...
              <ul class="flex ml-5 hover:text-white">
                ...
                <li></div><a href="https://www.facebook.com/profile.php?id=100076407723343"><img class="w-12 rounded-full mx-2 " src="../../../src/imgs/facebooklog" alt=""></a></li>
