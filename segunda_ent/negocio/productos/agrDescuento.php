      ...
      <div class="flex mb-10">
        ...
        <div class="flex flex-col w-full mx-14 ">
          <div class="flex  w-full mt-5">
              <h2 class="text-lg md:text-3xl mx-auto pb-4 w-full text-center border-b border-gray-300">Agregar Descuento</h2>
            </div>
            ...
            <br><p class="foto">Nombre</p>  <input class="controls" placeholder="Nombre Producto" type="text" name="nom2" disabled value="<?php echo $nom; ?>" required maxlength="30" size="40">

            <br> <p class="foto">Stock</p> <input class="controls" placeholder= "Stock" type="number" min="1" name="sto2" disabled  value="<?php echo $sto; ?>" required maxlength="30" size="40">

            <br> <p class="foto">Descuento</p> <input class="controls" placeholder= "Descuento" type="number" min="1" name="desc"   value="" required maxlength="30" size="40">

                    
            <br> <p class="foto">Precio</p> <input class="controls" placeholder="Precio" type="number" min="1" name="pre2" disabled value="<?php echo $pre; ?>" required maxlength="30" size="40">

            <br><p class="foto">Descripción</p> <input class="controls" placeholder="Descripcion Producto" type="text" name="desc2"disabled  value="<?php echo $desc; ?>" required maxlength="30" size="40">
            <div class="photo">
            ...
            <input class="botons" type="submit" value="Agregar" name="agr">
